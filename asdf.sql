...
#create table members ( id INT AUTO_INCREMENT PRIMARY KEY, name varchar(20),num varchar(11),age int ,trainer varchar(15) references trainers(name),s_date date,e_date date,sub double);
...
#drop table members;
#drop table expired;
#Select sub from members where id=(select max(id) from members)
#drop table members;
#ALTER TABLE members AUTO_INCREMENT = 1;

#delete from members where id>=1 and e_date<=curdate();
#drop table trainers;
#create table trainers (id int primary key auto_increment,name varchar(20),age varchar(20),SSN varchar(14) ,st_date date,num varchar(11),salary double );
#insert into trainers values(1,"anas","20","30412049503265","2023-12-15","01116569594",0.0);

#insert into trainers (name,age,SSN,st_date,num,salary) values("bavely","20","31503031403183","2023-10-20","01280491677",0.0),("ayat","19","31703041809560","2020-10-21","01060134256",0.0),("aya","19","30506044816193","2025-07-18","01225319610",0.0),("saleh","19","31908041506193","2027-12-09","01122536499",0.0),("basmla","19","30311041704173","2023-10-15","01002287616",0.0);
UPDATE trainers
SET salary = (SELECT COUNT(*) FROM members WHERE members.trainer = trainers.name )  WHERE id >= 1;
